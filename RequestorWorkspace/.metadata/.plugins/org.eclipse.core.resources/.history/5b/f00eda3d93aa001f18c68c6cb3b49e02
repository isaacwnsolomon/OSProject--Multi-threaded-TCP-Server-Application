        ...
        try {
            ...
            do {
                ...
                if (message.equalsIgnoreCase("1")) {
                    ...
                    sendMessage(message);               // Send first number

                    message = (String) in.readObject();
                    System.out.println(message);
                    message = input.nextLine();
                    sendMessage(message);               // Send second number

                    message = (String) in.readObject();
                    System.out.println(message);        // Receive and display result
                }
                // If user selected option 2 (Multiplication)
                    ...
                    System.out.println(message);
                    message = input.nextLine();
                    sendMessage(message);               // Send third number
